...
namespace COMP3A.LectureActivity7
{
    internal class Program
    {
        static void Main(string[] args)
        {
             ...
             * They are stored in sequential blocks memory, making it extremely fast to access them.
